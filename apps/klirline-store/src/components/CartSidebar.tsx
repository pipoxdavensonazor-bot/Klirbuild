import { X, Plus, Minus, Trash2, ShoppingBag, Smartphone } from 'lucide-react';
        ...
        {cartItems.length === 0 ? (
          ...
          <>
            ...
            <div className="border-t border-gray-200 p-4 bg-gray-50">
              ...
              <button className="w-full bg-orange-500 hover:bg-orange-600 text-white py-3 rounded-lg font-semibold transition-colors shadow-md hover:shadow-lg flex items-center justify-center gap-2"
