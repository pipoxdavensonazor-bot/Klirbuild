...
const coreNav: NavDef[] = [
  ...
  { href: "/presence", label: "Présence bureau", icon: UserCheck, permission: ["timeclock:manage", "location:view", "users:manage"], planFeature: "timeclock" },
  ...
  { href: "/admin/governance", label: "Gouvernance", icon: Shield, permission: ["users:manage", "company:manage"] },
